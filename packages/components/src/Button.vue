...
const buttonClasses = computed(() => {
  const variants = {
    ...
    outline: 'bg-transparent border-2 border-neutral-300 dark:border-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:border-neutral-400 dark:hover:border-neutral-500 active:bg-neutral-100 dark:active:bg-neutral-700 text-neutral-900 dark:text-neutral-100',
